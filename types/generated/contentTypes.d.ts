...
export interface ApiBookingDecorationItemBookingDecorationItem
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    decoration_item: Schema.Attribute.Relation<
      'manyToOne',
      'api::decoration-item.decoration-item'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    UnitPrice: Schema.Attribute.Float;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiBookingFurnitureItemBookingFurnitureItem
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    furniture_item: Schema.Attribute.Relation<
      'manyToOne',
      'api::furniture-item.furniture-item'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiBookingUtensilItemBookingUtensilItem
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    utensil_item: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    booking_decoration_items: Schema.Attribute.Relation<
      'oneToMany',
      'api::booking-decoration-item.booking-decoration-item'
    >;
    booking_furniture_items: Schema.Attribute.Relation<
      ...
      'api::booking-furniture-item.booking-furniture-item'
    >;
    booking_utensil_items: Schema.Attribute.Relation<
      'oneToMany',
      'api::booking-utensil-item.booking-utensil-item'
    >;
...
export interface ApiDecorationItemDecorationItem
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    DecorationImage: Schema.Attribute.Media<
    ...
    > &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String;
    PricePerItem: Schema.Attribute.Float;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiFurnitureItemFurnitureItem
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    FurnitureImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String;
    PricePerUnit: Schema.Attribute.Float;
    publishedAt: Schema.Attribute.DateTime;
    Style: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiUtensilItemUtensilItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    UtensilImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::booking-decoration-item.booking-decoration-item': ApiBookingDecorationItemBookingDecorationItem;
      'api::booking-furniture-item.booking-furniture-item': ApiBookingFurnitureItemBookingFurnitureItem;
      'api::booking-utensil-item.booking-utensil-item': ApiBookingUtensilItemBookingUtensilItem;
      'api::booking.booking': ApiBookingBooking;
      'api::credential.credential': ApiCredentialCredential;
      'api::customer.customer': ApiCustomerCustomer;
      'api::decoration-item.decoration-item': ApiDecorationItemDecorationItem;
      'api::event-type.event-type': ApiEventTypeEventType;
      'api::furniture-item.furniture-item': ApiFurnitureItemFurnitureItem;
      'api::location.location': ApiLocationLocation;
      'api::payment.payment': ApiPaymentPayment;
      'api::user-role.user-role': ApiUserRoleUserRole;
      'api::utensil-item.utensil-item': ApiUtensilItemUtensilItem;
